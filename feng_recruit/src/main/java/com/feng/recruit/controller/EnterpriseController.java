...
import com.feng.recruit.pojo.Enterprise;
import com.feng.recruit.service.EnterpriseService;
...
public class EnterpriseController {
	...
	public Result hotList(){
		...
		return new Result(true,StatusCode.OK,enterpriseService.findByIshotnd("1"));
	}
